...
export default function RightFloatArea({floatSlot}) {
  return (
    <div
      className=' opacity-100 duration-300 transition-all bottom-12 right-1 fixed justify-end z-20  text-white bg-indigo-500 dark:bg-hexo-black-gray rounded-sm'>
      <div
